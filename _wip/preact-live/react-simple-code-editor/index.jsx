...
var Editor = class Editor extends React.Component {
  static defaultProps = {
    tabSize: 2,
    insertSpaces: true,
    ignoreTabKey: false,
    ...
    if (overwrite) {
      ...
      if (last && timestamp - last.timestamp < HISTORY_TIME_GAP) {
        ...
        if (previous && current && current[1].startsWith(previous[1])) {
          ...
          this._history.stack[this._history.offset] = { ...record,
            timestamp
          };
          return;
        }
  ...
  _applyEdits = (record) => {
    ...
    if (last && input) {
      this._history.stack[this._history.offset] = { ...last,
  ...
  render() {
    ...
    return <div {...rest} style={{ ...styles.container,
      ...style
    }}>
        <textarea ref={c => this._input = c} style={{ ...styles.editor,
        ...styles.textarea,
        ...contentStyle
      }} className={className} id={textareaId} value={value} onChange={this._handleChange} onKeyDown={this._handleKeyDown} onClick={onClick} onKeyUp={onKeyUp} onFocus={onFocus} onBlur={onBlur} disabled={disabled} form={form} maxLength={maxLength} minLength={minLength} name={name} placeholder={placeholder} readOnly={readOnly} required={required} autoFocus={autoFocus} autoCapitalize="off" autoComplete="off" autoCorrect="off" spellCheck={false} data-gramm={false} />
        <pre aria-hidden="true" style={{ ...styles.editor,
        ...styles.highlight,
        ...contentStyle
